...
//       {/* Main Grid: Description & Curriculum */}
//       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
//         {/* Left Column: Full Description & Curriculum */}
...
//               {courseData.description || courseData.short_description || 'Detailed syllabus and guidelines.'}
//             </div>
//           </div>
...
//               className="w-full py-3.5 px-4 bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary-hover)] text-white font-semibold rounded-xl transition shadow-sm text-sm"
//             >
//               {user ? 'Go to Learning Dashboard' : 'Sign In to Enroll'}
//             </button>
...
export default function CourseDetailsPage() {
  ...
  // slug বা id যাই হোক আইডিটি ধরবে
  ...
  useEffect(() => {
    ...
    const fetchCourse = async () => {
      try {
        ...
        // Strapi v5-এ documentId/id দিয়ে সরাসরি ফেচ করা
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-[var(--color-brand-border)] rounded-2xl p-6 shadow-sm space-y-6 sticky top-24">
            ...
            <button
              onClick={handleEnrollClick}
              className="w-full py-3.5 px-4 bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary-hover)] text-white font-semibold rounded-xl transition shadow-sm text-sm cursor-pointer"
            >
              {user ? 'Go to Learning Dashboard' : 'Sign In to Enroll'}
            </button>
